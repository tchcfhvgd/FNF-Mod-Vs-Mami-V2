...
class ClientPrefs {
	...
	public static var toggleSkin:Bool = false;
	...
	public static var useSFBF:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.toggleSkin = toggleSkin;
		...
		FlxG.save.data.useSFBF = useSFBF;
	...
	public static function loadPrefs() {
		...
		if (FlxG.save.data.toggleSkin != null){
			toggleSkin = FlxG.save.data.toggleSkin;
		}
		...
		if(FlxG.save.data.useSFBF != null) {
			useSFBF = FlxG.save.data.useSFBF;
		}
